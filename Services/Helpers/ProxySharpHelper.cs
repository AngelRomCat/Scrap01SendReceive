...
namespace Services.Helpers
{
    ...
    /// </summary>
    public static class ProxySharp
    {
        /// <summary>
        ...
        static ProxySharp()
        {
            queue = ScrapeHelper.ScrapeProxies();
        }
        ...
        {
            int proxisQueHay = queue.Count;
            Random random = new Random();
            int intRandom = random.Next(0, proxisQueHay);
            var proxy = queue[intRandom];
